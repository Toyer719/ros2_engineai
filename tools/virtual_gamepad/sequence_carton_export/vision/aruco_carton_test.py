...
class ArucoCartonLocator(Node):
    ...
    def __init__(self, args):
        ...
        # Expose la derniere mesure pour un usage programmatique (ex.
        # walk_to_camera_distance_real.py) -- ajoute le 2026-08-31, ne change rien au
        # comportement standalone existant (juste un attribut de plus, rien retire).
    ...
    def _on_image(self, msg: Image):
        ...
        # Expose la derniere frame (annotee plus bas si detection) pour un usage
        # programmatique (ex. sauvegarde sur disque pour visu hors Foxglove) --
        # ajoute le 2026-09-01, meme esprit que last_distance ci-dessus.
