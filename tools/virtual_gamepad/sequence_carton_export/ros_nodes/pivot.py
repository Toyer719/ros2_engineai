...
class PivotActionServer(Node):
    ...
    def _execute(self, goal_handle):
        ...
        # Reconstruit exactement l'angle bras "serrage" que lift.py a etabli
        # (meme chemin approche->serrage, pour ne pas sauter d'une pose bras
        # differente au premier message de ce node).
        ...
        if g.depivot_before_release or cancelled:
